...
#     '''
#    （1） GRL中lamada参数计算
#    （2）第二阶段适应因子lamada，式23
#     Args:
#         p:代表迭代进程相对值，即当前迭代次数与总迭代次数的比率, p=(i_iter - args.warmup_step) / float(args.max_step)
#         gamma:constants=10
#
#     Returns:逐渐从0到1
#
...
def lr_poly(base_lr, i_iter, alpha=10, beta=0.75, num_steps=250000):
    ...
    if i_iter == 0:
        ...
        # adjust_lr = base_lr
        # print('base_lr = {}, alpha = {}, i_iter = {}, num_steps = {}, beta = {}'.format(base_lr, alpha, i_iter, num_steps, beta))
        # print('adjust_lr = ', adjust_lr)
